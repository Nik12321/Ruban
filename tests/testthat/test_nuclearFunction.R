...
test_that("Test Ruban algorithm for uncorrect values", {
  expect_error(Ruban(x = NaN, deltaX = c(10, 10), f = function(x) {
    x[1] + x[2]
    }
    , lower = c(-10, -10), upper = c(10, 10)))
  expect_error(Ruban(x = c(123, NaN), deltaX = c(10, 10), f = function(x) {
    x[1] + x[2]
    }
                     , lower = c(-10, -10), upper = c(10, 10)))
  expect_error(Ruban(x = NULL, deltaX = c(10, 10), f = function(x) {
    x[1] + x[2]
    }
                     , lower = c(-10, -10), upper = c(10, 10)))
  expect_error(Ruban(x = c(123, NULL), deltaX = c(10, 10), f = function(x) {
    x[1] + x[2]
    }
                     , lower = c(-10, -10), upper = c(10, 10)))
  expect_error(Ruban(x = 123, deltaX = c(10, 10), f = function(x) {
    x[1] + x[2]
    }
    , lower = c(-10, -10), upper = c(10, 10)))
  expect_error(Ruban(x = c(123, 100, 100), deltaX = c(10, 10), f = function(x) {
    x[1] + x[2]
    }
    , lower = c(-10, -10), upper = c(10, 10)))

  expect_error(Ruban(x = c(10, 10), deltaX = NaN, f = function(x) {
    x[1] + x[2]
    }
    , lower = c(-10, -10), upper = c(10, 10)))
  expect_error(Ruban(x = c(10, 10), deltaX = c(123, NaN), f = function(x) {
    x[1] + x[2]
    }
    , lower = c(-10, -10), upper = c(10, 10)))
  expect_error(Ruban(x = c(10, 10), deltaX = NULL, f = function(x) {
    x[1] + x[2]
    }
    , lower = c(-10, -10), upper = c(10, 10)))
  expect_error(Ruban(x = c(10, 10), deltaX = c(123, NULL), f = function(x) {
    x[1] + x[2]
    }
    , lower = c(-10, -10), upper = c(10, 10)))
  expect_error(Ruban(x = c(10, 10), deltaX = 123, f = function(x) {
    x[1] + x[2]
    }
    , lower = c(-10, -10), upper = c(10, 10)))
  expect_error(Ruban(x = c(10, 10), deltaX = c(123, 123, 123), f = function(x) {
    x[1] + x[2]
    }
    , lower = c(-10, -10), upper = c(10, 10)))

  expect_error(Ruban(x = c(10, 10), deltaX = c(20, 20), f = function(x) {
    x[1] + x[2]
    }
